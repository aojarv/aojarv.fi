  ...
  const Qna = props => {
    return (
      <div className={props.color}>
        <div className="aandq">
          <div className="question">Q: {props.q}</div>
          <div className="answer">A: {props.a}</div>
        </div>
      </div>
    );
  };
      ...
      <div className="qna" id={props.id}>
        <div className="cont1">
          <Qna
            color={props.c1}
            q="Hobbies?"
            a="Videogames, road cycling, downhill skiing and many others!"
          />
          <Qna
            color={props.c2}
            q="Which coding languages do you know?"
            a="Python (good), Java (good), React (great), TypeScript (basics), NodeJS (good), CSS (good). At the moment focus is on web development languages."
          />
      ...
      <div className="qna" id={props.id}>
        <div className="cont1">
          <Qna
            ...
            a="Finnish, English, Swedish, German"
          />
          <Qna
            color={props.c4}
            q="What do you study?"
            a="Computer science at University of Turku"
          />
          <Qna
            color={props.c5}
            q="Interests?"
            a="Investing (in shares and ETFs) is the biggest one at the moment"
          />
        </div>
        <div className="cont2">
          <div className="center">
