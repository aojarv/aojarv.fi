      ...
      return(
        <div className="qna" id={props.id}>
          <div className="cont1">
            ...
            <Qna color={props.c5} q="Interests?" a="Investing, cooking, Web developing, PCs"/>
      ...
      return(
        <div className="qna" id={props.id}>
          ...
          <Qna color={props.c3} q="Which languages do you know?" a="Finnish, English, Swedish, German"/>
            <Qna color={props.c4} q="Conscription?" a="Looking to join Air Forces in summer 2021 and become a pilot"/>
            <Qna color={props.c1} q="Favourite school subjects?" a="Mathematics, physics and chemistry."/>
          </div>
          <div className="cont2">
