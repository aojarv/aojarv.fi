...
const Projects = () => {
  ...
  const portfoliotext =
    "aojarv.fi, this site. I created this one to introduce me and my projects. Created by using React. Runs on Google Firebase. Focus was on design and creating well structured code. Still a lot to be improved. Will try to keep this site up to date.";

  const CCandWAtext =
    "For example a weatherapp and a currency converter. Simple projects that I created by using React just to learn to use APIs. Scrappy design and poor structure in codes. No backend. Will make them better at some point.";
    ...
    return (
      <div className="top">
        ...
        <div className="right">
          ...
          <div className={luokka.e}>
            <Linkki className="link" to="/contact">
              Contact
            </Linkki>
          </div>
        </div>
        ...
        <div className={props.class} id={props.id}>
          ...
          <div className="center">
            ...
            <a href onClick={scrollToTop}>
              <img className="totop" src={Totop} alt=""></img>
            </a>
          </div>
        </div>
      </>
      ...
      <>
        <div className="projectideas" id={props.id}>
          <div className="projectideasheader">
            <div className={props.c1}>What next?</div>
          </div>
          <div className="projectideascontent">
            <p className={props.c2}>
              A stock tracking application, a blackjack game, some bigger
              project would be cool to create
            </p>
            <p className={props.c3}>
              Learning TypeScript, VueJS, AngularJS, getting better with AWS
            </p>
